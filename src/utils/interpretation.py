...
def save_gradcam(
    model, image_tensor, label, pred, device, save_path="outputs/figures/grad_cam.png"
):
    """
...
def save_attention_map(
    model, image_tensor, label, pred, device, save_path="outputs/figures/attention_map.png"
):
    """
    ...
    with torch.no_grad():
        ...
        attn_output, attn_weights = last_layer.self_attn(
            x_emb, x_emb, x_emb, average_attn_weights=True
        )
